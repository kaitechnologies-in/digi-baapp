      ...
      <div className="grid gap-14 place-items-center container mx-auto relative">
        ...
        <div className="grid lg:grid-cols-4 gap-7 mt-8">
          <div className="bg-creamy py-16 px-10 flex flex-col gap-7 justify-center rounded-3xl items-center col-span-2 text-center">
            ...
            <span className="text-center font-urbanist text-4xl font-normal">Elevate your brand identity to its full potential by harnessing the true power of branding.</span>
          </div>
          <div className="bg-creamy py-16 px-10 flex flex-col gap-7 justify-center rounded-3xl items-center col-span-2 text-center">
            <span className="phudu-font text-5xl text-zeus uppercase">WEB Craft</span>
            <span className="text-center font-urbanist text-4xl font-normal">Transforming visions into compelling websites. Our design expertise, your online success.</span>
          </div>
          <div className="bg-creamy py-16 px-10 flex flex-col gap-7 justify-center rounded-3xl items-center col-span-2 text-center">
            <span className="phudu-font text-5xl text-zeus uppercase">DIGI Marketing</span>
            <span className="text-center font-urbanist text-4xl font-normal">We tailor strategies for growth, from SEO to social media, driving results and ROI.</span>
          </div>
          <div className="bg-creamy py-16 px-10 flex flex-col gap-7 justify-center rounded-3xl items-center col-span-2 text-center">
            <span className="phudu-font text-5xl text-zeus uppercase">PR BAAP</span>
            <span className="text-center font-urbanist text-4xl font-normal">We craft compelling stories and strategies that drive influence and boost your reputation</span>
          </div>
        </div>
        <div className="relative">
          <button className="phudu-font text-5xl text-orange border-solid border border-orange rounded-3xl py-4 px-12 h-auto  text-center hover:text-white hover:bg-orange max-w-3xl sm:max-w-full">Explore All Services</button>
